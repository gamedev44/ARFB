#Copyright (c) 2025 IronWill Interactive
#This code is open source under the Apache 2.0 license.

bl_info = {
    "name": "Action Recorder",
    "author": "IronWill Interactive Released by Asterisk",
    "version": (1, 0, 0),
    "blender": (3, 6, 2),
    "location": "Dope Sheet Editor ▶ Sidebar ▶ Animation",
    "category": "Animation",
    "description": "Action Recorder for Blender (ARFB)",
    "warning": "",
    "wiki_url": "",
    "tracker_url": ""
}
...
#Gui panel
###########
class DOPESHEET_PT_ARFB(bpy.types.Panel):
    bl_label = "Action Recorder"
    bl_idname = "DOPESHEET_PT_ARFB"
